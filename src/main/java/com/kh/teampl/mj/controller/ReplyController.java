...
import com.kh.teampl.mj.service.ReplyService;
import com.kh.teampl.mj.vo.ReplyVo;
...
public class ReplyController {
	...
	public List<ReplyVo> getReplyList(int board_no) {
		System.out.println("ReplyController, replyList" + replyService.getReplyList(board_no));
	...
	public String comment(ReplyVo replyVo) {
		System.out.println("ReplyController, replyVo : " + replyVo);
	...
	public String nestedComment(ReplyVo replyVo) {
		System.out.println("ReplyController, nest, replyVo: " + replyVo);
